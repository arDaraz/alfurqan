...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /Users/ahmeddaraz/VibeCoding/tasmi/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done
                  → writes to /Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
