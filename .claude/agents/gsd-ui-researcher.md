...
Use template from `/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
