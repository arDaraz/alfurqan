...
- Usage: Reference from command with `@/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ahmeddaraz/VibeCoding/tasmi/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ahmeddaraz/VibeCoding/tasmi/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
