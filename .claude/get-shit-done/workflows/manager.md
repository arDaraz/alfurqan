...
```bash
INIT=$(node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" init manager)
```
...
Steps:
1. Read the plan-phase workflow: cat /Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/workflows/plan-phase.md
2. Run: node \"/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat /Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/workflows/execute-phase.md
2. Run: node \"/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
