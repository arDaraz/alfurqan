...
<required_reading>
@/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/ahmeddaraz/VibeCoding/tasmi/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
