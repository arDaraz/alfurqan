/**
 * English meaning of each surah (the Quran.com `translated_name.name`).
 * Indexed by surah number 1..114. Used as the middle slot in the home list
 * row's Latin metadata: "Al-Fātiḥah · The Opening · Meccan".
 */
