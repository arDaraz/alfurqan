...
.w.playing,.rub.playing{background:${palette.selectedBackground};border-radius:4px;box-shadow:inset 0 0 0 1px ${palette.accent};transition:background 120ms ease,box-shadow 120ms ease}
</style>
</head>
<body>
${bodyContent}
